...
3. Select `infinity-scroll-0.0.1.vsix`.
4. Reload VS Code if prompted.

Or from the command line:

```bash
code --install-extension infinity-scroll-0.0.1.vsix
```
...
```jsonc
{
  ...
  "infinityScroll.triggerDelayMs": 400,
  ...
  "infinityScroll.edgeBufferLines": 0
}
```
